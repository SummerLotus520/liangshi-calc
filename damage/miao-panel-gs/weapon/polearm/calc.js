export default function (step, staticStep) {
  return {
    圣祭者的辉杖: {
      title: '攻击力提升[atkPct]%，元素充能效率提升[rechargePlus]%',
      data: {
        atkPct: step(8) * 3,
        rechargePlus: step(6) * 3
      }
    },
    掘金之锹: {
    ...
    灾悔: {
      ...
      data: {
        aDmg: ({ params, refine }) => 1.75 * step(40)[refine],
        a2Dmg: ({ params, refine }) => 1.75 * step(40)[refine],
        eDmg: ({ params, refine }) => 1.75 * step(40)[refine],
        qDmg: ({ params, refine }) => 1.75 * step(40)[refine]
      }
    }
  }
}
